...
Logs record events, errors, and system behavior. Together with the configuration,
they also help preserve enough context to interpret and reproduce an experiment.
...
- **Recommended format:** Use a structured, machine-readable format such as
  JSON, CSV, or Parquet when results will be aggregated later.
- **Example results log:**
