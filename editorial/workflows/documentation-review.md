...
- The target numbered chapter or chapters.
...
1. Read `AGENTS.md`, [`../writing-rules.md`](../writing-rules.md),
   [`../style.md`](../style.md), the complete target chapter, and nearby
   chapters on the same topic.
...
4. For each finding, report the chapter and section, the issue, its consequence,
